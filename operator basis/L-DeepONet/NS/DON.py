...
data_dir = 'NS/re_10_40/d_' + str(args.latent_dim) + '/' + str(args.method) + '/data/'
...
if not os.path.exists('re_10_40/d_' + str(args.latent_dim) + '/' + str(args.method) + '/errors_DON/'):
    os.makedirs('re_10_40/d_' + str(args.latent_dim) + '/' + str(args.method) + '/errors_DON/')     
if not os.path.exists('re_10_40d_' + str(args.latent_dim) + '/' + str(args.method) + '/class_DON/'):
    os.makedirs('re_10_40/d_' + str(args.latent_dim) + '/' + str(args.method) + '/class_DON/',exist_ok=True) 
if args.ood == 1:    
    if not os.path.exists('re_10_40/d_' + str(args.latent_dim) + '/' + str(args.method) + '/errors_OOD/'):
        os.makedirs('re_10_40/d_' + str(args.latent_dim) + '/' + str(args.method) + '/errors_OOD/')   
if args.noise == 1:
    if not os.path.exists('re_10_40/d_' + str(args.latent_dim) + '/' + str(args.method) + '/errors_NOISY/'):
        os.makedirs('re_10_40/d_' + str(args.latent_dim) + '/' + str(args.method) + '/errors_NOISY/')       
    
# Load autoencoder class
class_AE_dir = 'NS/re_10_40/d_' + str(args.latent_dim) + '/' + str(args.method) + '/class_AE/'
...
def preprocess(x, y):
    ...
    n = x.shape[0]
    X_func = x.reshape(n,10,ld_sqrt, ld_sqrt, 1) # (#, sqrt(ld), sqrt(ld), 1)
    #print(X_func.shape)

    X_loc = np.linspace(0, 1,nt).reshape(nt, 1)#yy
    #print(X_loc.shape)
